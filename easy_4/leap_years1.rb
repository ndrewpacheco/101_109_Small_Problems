...
# we are going to test if a given year is a leap year. 
# for leap year:
# # first check if year is divisible by 100
  # - if it is, it is not a leap year unless divisible by 400
  # else
# -- if ita evenly divisible by 4, it is a leap year
def leap_year?(year)
  if year % 100 == 0

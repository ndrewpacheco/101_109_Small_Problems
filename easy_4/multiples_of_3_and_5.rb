...
# range between 1.. and input number. select each number within that range that is a multiple of 3 or 5, and put it into array
# 


def multisum(num)
  multiples_array = (1..num).select do |n|
    n % 3 == 0 || n % 5 == 0
  end
  multiples_array.sum
end
